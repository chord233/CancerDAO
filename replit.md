...
- July 13, 2025. Finalized complete bilingual translation support for Resources page - implemented translation keys for category filters (全部/All, 癌症预防/Cancer Prevention, 治疗进展/Treatment Progress, 基因科技/Genetic Technology, 数据隐私/Data Privacy), FAQ section buttons (查看所有问题/View All Questions), and bottom CTA section (还有其他问题？/Have Other Questions?, 联系我们/Contact Us, 加入社区讨论/Join Community Discussion). Both Community and Resources pages now have 100% complete Chinese/English translation coverage.
- July 15, 2025. Added fourth step "个性化AI健康顾问" (Personalized AI Health Advisor) to AI analysis process in solution page, adjusted spacing from space-x-8 to space-x-6 for better visual balance across all four steps.
- July 15, 2025. Replaced entire global challenges section in homepage with unified image display - removed complex interactive card system and replaced with single centered image showing world map with data visualizations, maintaining section structure and styling consistency.