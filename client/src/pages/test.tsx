...
export default function Homepage() {
  ...
  return (
    <div className="min-h-screen">
      {/* ========== Hero 首屏区域 ========== */}
      <section className="hero-section relative overflow-hidden py-32 lg:py-40 bg-gradient-to-b from-[#F6F7FD] via-[#FFFFFF] to-[#EAE3FA]">
        {/* 背景图片层 - 半透明叠加 */}
        <div 
      ...
      <section className="py-20 bg-[#EAE3FA] relative">
        ...
        <div className="relative z-10">
          <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {/* 问题卡片网格 - 始终展示完整内容，无交互，等高卡片更大间距 */}
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-12 lg:gap-16 relative">
              {[
                { id: 0, icon: AlertTriangle, title: t("problem.global.title"), description: t("problem.global.description"), points: [t("problem.global.point1"), t("problem.global.point2")], image: "/attached_assets/2_1752591217296.jpg" },
                { id: 1, icon: Users, title: t("problem.knowledge.title"), description: t("problem.knowledge.description"), points: [t("problem.knowledge.point1"), t("problem.knowledge.point2"), t("problem.knowledge.point3")], image: "/attached_assets/3_1752591389815.jpg" },
                { id: 2, icon: TrendingUp, title: t("problem.innovation.title"), description: t("problem.innovation.description"), points: [t("problem.innovation.point1"), t("problem.innovation.point2")], image: "/attached_assets/4_1752591925448.jpg" }
              ].map((card) => (
                <div key={card.id} className="relative h-full">
                  <div className="problem-card relative z-10 shadow-lg transition-all duration-300 h-full flex flex-col rounded-xl">
                    ...
                    <img src={card.image} alt={card.title} className="w-full aspect-[16/9] rounded-lg mb-4 object-cover" />
