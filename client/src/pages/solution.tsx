          ...
          <div className="mb-16 flex justify-center">
            <div className="max-w-6xl w-full">
              <div className="relative bg-gradient-to-br from-purple-50 to-blue-50 rounded-2xl p-8 shadow-lg border border-purple-200">
                ...
                {/* Support Arrow */}
                <div className="absolute top-16 right-32" style={{ transform: 'translate(50px, 125px)' }}>
                  <div className="flex items-center">
                    <div className="flex flex-col items-center">
                ...
                <div className="flex justify-between items-center mt-56 mb-8 px-8 pl-[0px] pr-[0px]">
                ...
                {/* Flow Arrows */}
                <div className="absolute bottom-60 left-32" style={{ transform: 'translate(-25px, -50px)' }}>
                  <div className="flex items-center">
                    <div className="flex flex-col items-center">
                      <div className="w-0.5 h-4 bg-purple-400"></div>
                      <ArrowDown className="h-4 w-4 text-purple-400" />
                ...
                <div className="absolute left-1/4 top-1/2 transform translate-x-1/2 -translate-y-1/2" style={{ transform: 'translate(calc(50% - 25px), calc(-50% + 100px))' }}>
                  <div className="flex flex-col items-center">
