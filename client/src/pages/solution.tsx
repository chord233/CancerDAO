          ...
          <div className="max-w-4xl mx-auto mb-12 space-y-8">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-md border border-gray-200">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 rounded-full flex items-center justify-center mr-4" style={{ backgroundColor: '#c9a4ff' }}>
                  <Users className="h-6 w-6 text-white" />
                </div>
                <h3 className="text-xl font-bold text-black">以患者为核心的生态系统</h3>
              </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-md border border-gray-200">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 rounded-full flex items-center justify-center mr-4" style={{ backgroundColor: '#fad000' }}>
                  <Shield className="h-6 w-6 text-white" />
                </div>
                <h3 className="text-xl font-bold text-black">Web3 技术与 AI 驱动</h3>
              </div>
              <p className="text-lg text-black leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-md border border-gray-200">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 rounded-full flex items-center justify-center mr-4" style={{ backgroundColor: '#fc593d' }}>
                  <Coins className="h-6 w-6 text-white" />
                </div>
                <h3 className="text-xl font-bold text-black">可持续金融体系</h3>
              </div>
              <p className="text-lg text-black leading-relaxed">
