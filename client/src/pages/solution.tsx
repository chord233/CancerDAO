          ...
          <div className="mb-16 flex justify-center">
            <div className="max-w-6xl w-full">
              <div className="relative rounded-2xl p-8 shadow-lg border border-purple-200" style={{ background: 'linear-gradient(135deg, #f3f0ff 0%, #e6f3ff 100%)' }}>
                ...
                {/* Support Arrow */}
                <div className="absolute top-16 right-32" style={{ transform: 'translate(-250px, 110px)' }}>
                  <div className="flex items-center">
                    <div className="flex flex-col items-center">
                ...
                {/* Flow Arrows */}
                <div className="absolute bottom-60 left-32" style={{ transform: 'translate(-25px, -10px)' }}>
                  <div className="flex items-center">
                    <div className="flex flex-col items-center">
