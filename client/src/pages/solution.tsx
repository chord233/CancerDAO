          ...
          <div className="mb-16 flex justify-center">
            <div className="max-w-6xl w-full">
              <div className="relative bg-gradient-to-br from-purple-50 to-blue-50 rounded-2xl p-8 shadow-lg border border-purple-200">
                ...
                {/* Token Section */}
                <div className="absolute" style={{ top: '57px', left: 'calc(50% + 38px)' }}>
                ...
                {/* Support Arrow */}
                <div className="absolute top-16 right-32" style={{ transform: 'translate(-200px, 110px)' }}>
                  <div className="flex items-center">
                    <div className="flex flex-col items-center">
                ...
                {/* Flow Arrows */}
                <div className="absolute bottom-60 left-32" style={{ transform: 'translate(-25px, -35px)' }}>
                  <div className="flex items-center">
                    <div className="flex flex-col items-center">
