...
const translations = {
  zh: {
    ...
    "community.activities.event1.status": "即将开始",
    "community.activities.event1.title": "每周患者支持小组",
    "community.activities.event1.description": "每周日晚上8点，我们都会举办线上支持小组活动，为患者和家属提供情感支持和经验分享的平台。",
    "community.activities.event1.participants": "20-30人",
  ...
  en: {
    ...
    "community.activities.event1.status": "Coming Soon",
    "community.activities.event1.title": "Weekly Patient Support Group",
    "community.activities.event1.description": "Every Sunday at 8 PM, we host online support group activities to provide emotional support and experience sharing platform for patients and families.",
    "community.activities.event1.participants": "20-30 people",
