...
const translations = {
  zh: {
    ...
    "solution.core.intro.title": "革命性的医疗架构",
    "solution.core.intro.description": "CancerDAO 代表了癌症护理服务的范式转变。我们的创新架构将前沿的 AI 技术与区块链安全性相结合，创造出一个综合生态系统，赋能患者、加速研究，并改变我们对癌症预防和治疗的方法。",
    "solution.core.architecture.title": "系统架构概览",
  ...
  en: {
    ...
    "solution.core.intro.title": "Revolutionary Healthcare Architecture",
    "solution.core.intro.description": "CancerDAO represents a paradigm shift in cancer care delivery. Our innovative architecture combines cutting-edge AI technology with blockchain security to create a comprehensive ecosystem that empowers patients, accelerates research, and transforms how we approach cancer prevention and treatment.",
    "solution.core.architecture.title": "System Architecture Overview",
